...
#
# Source:  anthropics/skills — skills/skill-creator/scripts/quick_validate.py
# License: Apache License 2.0 (see tools/LICENSE-quick_validate.txt)
#
# Kept byte-identical to upstream below this header so it can be re-synced
# cleanly. This is the same code that gates skill uploads to claude.ai and the
# Skills API, which is exactly why it is vendored rather than reimplemented:
# our CI then enforces precisely what the upload path enforces.
# ---------------------------------------------------------------------------
#!/usr/bin/env python3
"""
